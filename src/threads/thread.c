...
//  printf("Initializing thread system...\n");
  ...
  #ifdef USERPROG
  //----------WAIT
 // printf("Initial thread child_thread list initialized.\n");
  list_init(&initial_thread -> child_thread);

  //---------FIle DIRECTORY
  list_init(&initial_thread -> file_descriptor);
  #endif
}
